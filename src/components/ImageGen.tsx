    ...
    <>
      ...
      <div className="w-3/5 max-sm:w-4/5 flex flex-col justify-center items-start ">
        ...
        <div className="w-full h-96 flex justify-center items-center">
          ...
          {!loading && imageUrl && (
            <img
              className=" h-96 object-contain" style={{ height: "100px;" }}
              src={imageUrl}
              alt="Fetched content"
            />
          )}
          {!loading && !imageUrl && (
            <div className="w-full h-96 flex justify-center items-center text-center bg-[#E2E2E2] dark:bg-[#ffffff] rounded-sm font-inter text-xl font-bold">
